...
- The figure about the plots of SCM procedures for Wenzhou and Shanghai was generated by running `figure2.R`. 
...
- The estimation of Susceptible (S), Infectious (I), self-Healing (H), and Positive(P) individuals for the dynamic system in the paper by runing `Epidemic_model.R`.
- The figure about the effective reproduction number for different periods was generated  by runing `R_0_plot.R`.
- The parameters of state space SIHP models for Wenzhou and Shanghai were obtained by running `WZ.R` and `SH.R`.
- The simulation of the trajcetories of COVID-19 for the goodness of the fit about the proposed SIHP model was generated by running `Sim_epi_plot.R`.  
